...
@RestController
@RequestMapping("/api/alarm-kafka")
public class AlarmKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AlarmKafkaResource.class);
    ...
    public AlarmKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
